 ...
 * @author 马青松
 */
public class MsSqlserverSqlInfoBuilder implements SqlInfoBuilder {
    /**
     * 日志打印
     */
    private static final Logger logger = Logger.getLogger(MsSqlserverSqlInfoBuilder.class);
    ...
    public String buildPageSql(String sql, PagerBean page) {
        ...
        pageSql.append(sql);
        pageSql.append(" ) tablerows ");
        pageSql.append(" WHERE tablerows.rownum between ").append(page.getStartRow()).append(" AND ").append(page.getEndRow());
        pageSql.append(" ORDER BY tablerows.rownum ASC ");
